<?php
/**
 * NOTICE: This is php library and its not formated acording to Magento2 coding standards
 * File: Browser.php
...
class Browser extends \Zend_Http_UserAgent
{
    private $_agent = '';
    ...
    public function reset()
    {
        ...
        $userAgentHeader= $serverData['http_user_agent'];
        $this->_agent = isset($userAgentHeader) ? $userAgentHeader : '';
